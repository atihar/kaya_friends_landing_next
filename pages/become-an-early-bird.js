...
function BecomeAnEarlyBird() {
    ...
    const service_id = "service_l9hzioe"
    const template_id = "template_x2x9zfu"
    const public_key = "y2i3Sk4z_7Vyi4uZC"
  ...
  return (
    ...
    <form ref={form} onSubmit={sendEmail}>
        <div className='max-w-screen-md mx-auto text-white bg-gray-400 bg-opacity-20 p-8 md:p-14 rounded-lg md:my-24'>
            ...
            <div className='grid md:grid-cols-2 gap-2 mt-16'>
                ...
                <input className="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="username" name="user_name"></input>
            </div>
            <div className='grid md:grid-cols-2 gap-2 mt-8'>
                <p className='font-bold'>Living city</p>
                <input className="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="living_city" type="text" placeholder="dubai" name="living_city"></input>
            </div>
            <div className='grid md:grid-cols-2 gap-2 mt-8'>
                <p className='font-bold'>Email</p>
                <input className="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="text" placeholder="john@company.com" name="user_email"></input>
            </div>
            <div className='grid md:grid-cols-2 gap-2 mt-8'>
                <p className='font-bold'>Industry</p>
                <input className="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="industry" type="text" placeholder="technology" name="industry"></input>
            </div>
            <div className='grid md:grid-cols-2 gap-2 mt-8'>
                <p className='font-bold'>How did you hear about us?</p>
                <select type="select" className='shadow border rounded w-full py-2 px-3 text-gray-700' name="reference">
